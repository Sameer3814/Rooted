...
Usage
-----
    py pipeline/parse_books.py                      # genesis + psalms + exodus + ruth + leviticus + numbers + deuteronomy + joshua + judges + 1samuel + 2samuel + 1kings + 2kings (shipped set)
...
DEFAULT_BOOKS = ["genesis", "psalms", "exodus", "ruth", "leviticus", "numbers", "deuteronomy", "joshua", "judges", "1samuel", "2samuel", "1kings", "2kings"]
