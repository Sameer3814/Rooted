...
Usage
-----
    py pipeline/parse_books.py                      # genesis + psalms + exodus + ruth + leviticus + numbers + deuteronomy + joshua + judges (shipped set)
...
DEFAULT_BOOKS = ["genesis", "psalms", "exodus", "ruth", "leviticus", "numbers", "deuteronomy", "joshua", "judges"]
