...
- `data/starter-pack.json` — the curated seed content the app loads on
  first run: **1,128 verses** — the entire Old Testament plus the New
  ...
  (topics linked to related topics), plus **157 characters** with real
...
- `data/characters.json` — the same 157 characters, standalone. Generated
...
- `data/verses.json` — the **full** parsed corpus: the entire Old
  ...
  the user's overlay. Only the 1,128 seed verses are topic-tagged; the
  rest of the corpus isn't yet.
- `data/stories.json` — 16 eras, **228 stories and 515 life events**.
...
9. **Expanding into the New Testament — started 2026-09-10, owner's
   ...
   **Progress: all four Gospels are fully curated** — the birth of
   ...
   and Saul's conversion on the road to Damascus — Acts is underway.
